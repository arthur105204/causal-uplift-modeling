...
bootstrap; one-shot held-out evaluation. Causal Forest remains a mandatory main
comparator (D15). T03-C randomization calibration remains mandatory before
T16/pre-test freeze.
